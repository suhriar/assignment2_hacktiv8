...
func (o *OrderService) CreateOrder(request params.CreateOder) *params.Response {
...
func (o *OrderService) UpdateOrderByID(orderId int, request params.CreateOder) *params.Response {
